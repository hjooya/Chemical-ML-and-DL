...
Adjacency = zeros(250,250,0);
Features = zeros(250,7,0);    % Consider all 7 features
...
for S = 0:7
        filename = ['tox21','_','graph','_',num2str(S),'.mat'];
...
% Double check the sizes and make sure they are correct:
        ...
        fprintf('Total number of toxic molecules is [%s]\n', int2str(toxmols))
        fprintf('Total number of nontoxic molecules is [%s]\n', int2str(nontoxmols))
